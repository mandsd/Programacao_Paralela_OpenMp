...
int main() {
    ...
    /* O código simula o processamento de dados salariais de 2 milhões de funcionários
    da empresa fictícia NeoTech, utilizando OpenMP com reductions para otimizar o desempenho.
    Ele gera salários determinísticos entre R$1.500 e R$20.000 e associa cada funcionário 
    a um departamento e cargo. Em seguida, o programa calcula a média salarial, a variância 
    amostral e o desvio padrão, tudo de forma paralelizada e eficiente. O uso da cláusula
    `reduction` elimina a necessidade de locks, tornando o cálculo significativamente mais
    rápido, como demonstrado pelo tempo de execução reduzido.
    */
