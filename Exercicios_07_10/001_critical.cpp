...
int main() {
    ...
    /* O código utiliza OpenMP para paralelizar o cálculo das raízes de várias equações do segundo
     grau usando a fórmula de Bhaskara. O usuário informa quantas equações deseja resolver, e o programa
     preenche uma lista alternando entre equações com e sem raízes reais. Em seguida, ele calcula o delta e 
     as raízes em paralelo, conta quantas equações têm soluções reais e mede o tempo total de execução. 
     O objetivo é demonstrar como o paralelismo pode acelerar o processamento de tarefas independentes e 
     comparar o desempenho em relação à execução sequencial.
    */
